...
import { PROJECTS_API, PROJECTS_TAGS_API } from "@/endpoints";
...
const Project = () => {
    ...
    const { data: projects, loading: projectsLoading, error: projectsError, fetchData: fetchProjects } = useFetch(`${PROJECTS_API}`, []);
    const { data: datas, loading: Loading, error: Error, fetchData: fetchTags } = useFetch(PROJECTS_TAGS_API, []);
            ...
            <main className="flex-1 px-6 py-10 md:px-12 md:py-14 max-w-7xl w-full mx-auto">
                <div className="space-y-10">
                    ...
                    <p className="text-base md:text-lg text-gray-600 leading-relaxed -mt-2">
                        Maintaining and developing +40 open source projects on{" "}
                        <a 
                            href="https://github.com/septaanugrahperkasa" 
                            target="_blank" 
                        ...
                        . Use the buttons to switch to different categories
                    </p>
